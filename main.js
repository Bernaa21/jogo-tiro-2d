...
function start(){
    ...
    $("#fundogame").append("<div id='player' class='anim1'></div>");
...
var somcomeco=document.getElementById("somcomeco");
...
jogo.pressionado[e.which] = true;
});

$(document).keyup(function(e){
    jogo.pressionado[e.which] = false;
});
...
function movefundo(){
    ...
    $("#fundogame").css("background-position" ,left-2);
}

function moveplayer() {

    if (jogo.pressionado[tecla.W]) {
    ...
    if (jogo.pressionado[tecla.seta]) {
...
function colisao() {
    var colisao1 = ($("#player").collision($("#inimigo1")));
    // jogador com o inimigo1
    var colisao2 = ($("#player").collision($("#inimigo2")));
    // jogador com o inimigo2
    var colisao3 = ($("#disparo").collision($("#inimigo1")));
    // disparo com o inimigo 1
    var colisao4 = ($("#disparo").collision($("#inimigo2")));
    //disparo com o inimigo 2
    var colisao5 = ($("#player").collision($("#aliado")));
    // player com aliado
